class Renderer {
    ...
    constructLine(path) {
        ...
        const indexBuffer = new GLBuffer(this.gl, this.gl.ELEMENT_ARRAY_BUFFER)
        indexBuffer.setUIntBuffer()
        const positionBuffer = new GLBuffer(this.gl, this.gl.ARRAY_BUFFER)
        const previousBuffer = new GLBuffer(this.gl, this.gl.ARRAY_BUFFER)
        const nextBuffer = new GLBuffer(this.gl, this.gl.ARRAY_BUFFER)
        const directionBuffer = new GLBuffer(this.gl, this.gl.ARRAY_BUFFER)
        let count = 0;
