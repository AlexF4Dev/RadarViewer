class Map {
    constructor(canvas, latlng) {
        ...
        this.stats.dom.style = "position: fixed; top: 0px; right: 0px; cursor: pointer; opacity: 0.9; z-index: 10000;"
    ...
    init() {
        ...
        /*this.buffer = new GLBuffer(this.gl, this.gl.ARRAY_BUFFER);
    ...
    getLayersOfType(type) {
        return this.layers.find(layer => layer instanceof type);
    }
